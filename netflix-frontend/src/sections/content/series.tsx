      ...
      >
        {series.length > 0 && (
          <Box sx={{ flex: { xs: 1, sm: 0.5 } }}>
            <img
              src={series[0].Poster || 'https://via.placeholder.com/300x450'} // Fallback image if Poster is missing
              alt={series[0].Title || 'Featured Movie'} // Use movie Title or a generic fallback
        ...
        {series.length > 0 && (
          ...
          >
            ...
            >
              {series[0].Title || 'No title available'}
            </Typography>
            <Typography
            ...
            >
              {series[0].Plot || 'No plot available'}
            </Typography>
            <Box
              sx={{
                display: 'flex',
